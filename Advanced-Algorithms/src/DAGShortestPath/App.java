...
public class App {
	...
	/**
	 * 
	 * A legaltalanosabb algortimus: a Bellman-Ford -> O(E*V) nagyon lassu de
	 * robosztus...negativokat is kezelni tud Ha nem kellenek negativ elek -> jo a
	 * Dijkstra algoritmus is -> O(E+VlogV) time complexity dominal Meg ennel is
	 * leget gyorsabb, ha nem tartalmat cycleket ... DAG !! Ilyenkor -> O(E+V) lesz
	 * a time complexity pl.: Knapsack probelmet is vissza lehet vezetni egy ilyen
	 * DAG shortest path eljarasra
	 * 
	 */
